  ...
  return (
    <header className='absolute w-full z-50 px-5'>
      <div className='container mx-auto pt-6 pb-10'>
        <div className='flex flex-stretch item-center'>
          <div className='w-56 flex item-center'>
            <h2 className='logos'>Yasae.</h2>
          </div>
          <div className='w-full'></div>

          {/* START: Navigation */}
          <div className='w-auto'>
            <ul className='fixed bg-white inset-0 flex-col invisible item-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center'>
              <li className='mx-3 py-6 md:py-0'>
                <Button type='link' link='/' className='text-black md:text-black hover:underline'>
                  Home
                </Button>
              </li>
              <li className='mx-3 py-6 md:py-0'>
                <Button type='link' link='/products' className='text-black md:text-black hover:underline'>
                  Products
                </Button>
              </li>
              <li className='mx-3 py-6 md:py-0'>
                <Button type='link' link='/delivery' className='text-black md:text-black hover:underline'>
                  Delivery
                </Button>
              </li>
              <li className='mx-3 py-6 md:py-0'>
                <Button type='link' link='/rewards' className='text-black md:text-black hover:underline'>
                  Rewards
                </Button>
              </li>
              <li className='mx-3 py-6 md:py-0'>
                <Button type='link' link='/contact' className='text-black md:text-black hover:underline'>
                  Contact
                </Button>
              </li>
            </ul>
          ...
          <div className='w-auto'>
            <ul className='flex item-center'>
              ...
              <li className='ml-6'>
                <Button type='link' link='#' className='flex item-center justify-center text-black w8 h8'>
                  <svg className='fill-current' width='29' height='25' viewBox='0 0 29 25' fill='none' xmlns='http://www.w3.org/2000/svg'>
                    ...
                    <circle cx='25' cy='4.89023' r='4' fill='#59B828' className='cart-isfilled' />
                  </svg>
                </Button>
              </li>
            </ul>
