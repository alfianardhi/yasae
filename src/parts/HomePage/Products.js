    ...
    return (
      ...
      <div className="container mx-auto">
        <div className="flex flex-start justify-center text-center pl-3 md:justify-start md:text-left mb-4">
          <h3 className="text-xl md:text-2xl font-medium capitalize">We Recommend You<br className="" /><span className="font-normal text-base md:text-lg">The best choice specially for you</span></h3>
        </div>
          ...
          <div className="px-3 w-2/4 mb-4 md:w-3/12 xl:w-2/12">
            <div className="rounded-md p-4 pb-4 relative bg-white shadow">
              ...
              <div className="product-content w-full">
                ...
                <div className="price text-base text-green-500 mt-0.5">$2.00 <del>$5.00</del></div>
              </div>
              <div className="product-button mt-4 w-full">
                ...
                <div className="button-number hidden w-full container flex justify-center">
                  <button className="bg-green-400 h-10 w-10 flex items-center justify-center text-white capitalize rounded-full hover:bg-green-500 flex-none transition duration-200"><span>-</span></button>
